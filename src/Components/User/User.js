    ...
    return (
        <div className="card mx-5 mt-10 mb-16 border border-solid bg-base-100 shadow-xl">
            <div className="card-body flex-row justify-between items-center">
                ...
                <div>
                    <button className="btn btn-info rounded-3xl text-white">View Details</button>
                </div>

            </div>
            <div className='grid md:grid-cols-1 lg:grid-cols-2 gap-4  border border-solid rounded-2xl m-10 p-10'>
